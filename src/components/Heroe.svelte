<script>
  ...
  function getHeroeById(heroeId) {
    axios
      .get(`${API_BASE_URL}/heroes/${heroeId}`)
      .then(res => {
  ...
  function guardar() {
    ...
    if (heroeId !== 'nuevo') {
      ...
      axios
        .put(`${API_BASE_URL}/heroes/${heroeId}`, heroeData)
        .then(res => {
          if (res.data) {
            Swal.fire({
              position: 'top-end',
      ...
      axios
        .post(`${API_BASE_URL}/heroes`, heroeData)
        .then(res => {
          if (res.data) {
            Swal.fire({
              position: 'top-end',
